...
public class SignInModel {
    ...
    private static final Logger logger = Logger.getLogger(SignInModel.class);
    ...
    public static User getUserByLogPas(String login, String password){
        ...
        try {
            ...
            logger.info("SignInModel.getUserByLogPas() gave output");
            return user;
